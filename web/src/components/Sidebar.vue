...
<template>
  <section class="sidebar flex justify-between items-center md:justify-center md:items-start w-full md:w-32 md:h-screen shadow-lg">
    ...
    <div class="mx-5 my-3 flex md:flex-col items-center group" @click="handleAddNote">
      <span
      ...
      >
        <span @click="addNote('yellow')" class="w-5 h-5 rounded-full cursor-pointer bg-yellow"></span>
        <span @click="addNote('orange')" class="w-5 h-5 rounded-full cursor-pointer bg-orange"></span>
        <span @click="addNote('green')" class="w-5 h-5 rounded-full cursor-pointer bg-green"></span>
        <span @click="addNote('blue')" class="w-5 h-5 rounded-full cursor-pointer bg-blue"></span>
        <span @click="addNote('purple')" class="w-5 h-5 rounded-full cursor-pointer bg-purple"></span>
      </span>
